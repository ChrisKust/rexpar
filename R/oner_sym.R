oner_sym <- function(resid)
{
  ...
  MT <- 1 / 3 * ((resid[1] > 0) * (M2 < 0) * (M3 > 0) + (resid[1] < 0) * (M2 > 0) * (M3 < 0) + (resid[1] > 0) * (M2 > 0) * (M3 < 0) + (resid[1] < 0) * (M2 < 0) * (M3 > 0) + (resid[1] > 0) * (M2 < 0) * (M3 < 0) + (resid[1] < 0) * (M2 > 0) * (M3 > 0) )#-(resid[1]==0)*(M2==0)*(M3==0)
  return(sum(MT))
}